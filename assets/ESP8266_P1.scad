...
pcbLength           = 35; // front to back (X axis) was 40
pcbWidth            = 26; // side to side (Y axis)
pcbThickness        = 1.6; 
...
pcbStands = 
[
                   [3.4,         3.0,        yappBaseOnly, yappHole]  // back-left
                 , [3.4,         3.0,        17.0, yappLidOnly, yappHole] // back-right
                 , [3.4, pcbWidth-3, 17.0, yappLidOnly, yappHole] // front-left               
                 , [3.4, pcbWidth-3, yappBaseOnly, yappHole]  // front-right
                 
                 , [pcbLength+3, 3.0,       16.4, yappBaseOnly, yappHole]
                 
                 , [pcbLength+3, pcbWidth-3, 16.4, yappBaseOnly, yappHole]

                 , [pcbLength, 3.0,       17.0, yappLidOnly, yappHole]
                 
                 , [pcbLength, pcbWidth-3, 17.0, yappLidOnly, yappHole]
...
cutoutsFront =  
[
// 14 is de breedte van het gat
[(shellWidth/2)-7, 19.8, 14, 16, 1, yappRectangle, 0 , yappCoordBox] //-- pwr Hole
];

// [(shellWidth/2)-4, 4, 10, 20, 1, yappRoundedRect, yappCoordBox] //-- pwr Hole
// cutoutsBack = 
// [
// ];
